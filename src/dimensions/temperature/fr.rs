...
pub fn rules() -> Vec<Rule> {
    vec![
        ...
        Rule {
            ...
            pattern: vec![is_value_only(false), regex("(deg(r(é|e|è))?s?\\.?)|°")],
            production: Box::new(|nodes| {
        ...
        Rule {
            name: "<latent temp> en dessous de zero".to_string(),
            pattern: vec![is_value_only(true), regex("en dessous de (0|z(é|e)ro)")],
            production: Box::new(|nodes| {
