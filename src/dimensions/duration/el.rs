    ...
    vec![
        ...
        Rule {
            ...
            production: Box::new(|_| {
                Some(TokenData::Duration(DurationData::new(1, Grain::Second)))
            }),
        },
        Rule {
        ...
        Rule {
            ...
            production: Box::new(|_| {
                Some(TokenData::Duration(DurationData::new(1, Grain::Minute)))
            }),
        },
        Rule {
        ...
        Rule {
            ...
            pattern: vec![regex(
                r"(1/4|[εέ]ν(α|ός)\s+τ[εέ]τ[αά]ρτου?)(\s*ω|\s+(της\s+)?ώρας)?",
            )],
            production: Box::new(|_| {
        ...
        Rule {
            ...
            production: Box::new(|nodes| {
                ...
                let dd = match g {
                    Grain::Minute => {
                        DurationData::new(60_i64.checked_mul(v)?.checked_add(30)?, Grain::Second)
                    }
                    Grain::Hour => {
                        DurationData::new(60_i64.checked_mul(v)?.checked_add(30)?, Grain::Minute)
                    }
                    Grain::Day => {
                        DurationData::new(24_i64.checked_mul(v)?.checked_add(12)?, Grain::Hour)
                    }
                    Grain::Month => {
                        DurationData::new(30_i64.checked_mul(v)?.checked_add(15)?, Grain::Day)
                    }
                    Grain::Year => {
                        DurationData::new(12_i64.checked_mul(v)?.checked_add(6)?, Grain::Month)
                    }
                    _ => return None,
                };
        ...
        fixed(
            "15 minutes",
            r"δεκαπέντε λεπτά|δεκαπεντάλεπτο",
            15,
            Grain::Minute,
        ),
        ...
        fixed(
            "30 seconds digits",
            r#"30 δευτερόλεπτα|30""#,
            30,
            Grain::Second,
        ),
        fixed(
            "30 minutes",
            r"τριάντα λεπτά|μισάωρο|μισή ώρα",
            30,
            Grain::Minute,
        ),
        ...
        fixed(
            "45 minutes",
            r"τρία τέταρτα|σαρανταπεντάλεπτος",
            45,
            Grain::Minute,
        ),
        ...
        fixed(
            "60 hours",
            r"δυόμισι μέρες|60 ώρες|εξήντα ώρες",
            60,
            Grain::Hour,
        ),
        ...
        fixed(
            "2 years",
            r"δυο χρόνια|δύο έτη|διετία|διετής|δίχρονο",
            2,
            Grain::Year,
        ),
        fixed(
