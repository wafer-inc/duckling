    ...
    vec![
        ...
        Rule {
            ...
            production: Box::new(|_| {
                Some(TokenData::Duration(DurationData::new(10, Grain::Month)))
            }),
        },
        Rule {
        ...
        Rule {
            ...
            production: Box::new(|_| {
                Some(TokenData::Duration(DurationData::new(130, Grain::Minute)))
            }),
        },
        Rule {
            ...
            production: Box::new(|_| {
                Some(TokenData::Duration(DurationData::new(27, Grain::Month)))
            }),
        },
        Rule {
