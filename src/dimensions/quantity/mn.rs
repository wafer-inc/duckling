    ...
    vec![
        Rule {
            ...
            production: Box::new(|nodes| {
                ...
                Some(TokenData::Quantity(QuantityData::new(v, QuantityUnit::Gram)))
            }),
        },
        Rule {
        ...
        Rule {
            ...
            production: Box::new(|_| Some(TokenData::Quantity(QuantityData::new(0.001, QuantityUnit::Gram)))),
        },
        Rule {
            name: "a gram".to_string(),
            pattern: vec![regex("г(рамм?)?")],
            production: Box::new(|_| Some(TokenData::Quantity(QuantityData::new(1.0, QuantityUnit::Gram)))),
        },
        Rule {
        ...
        Rule {
            ...
            production: Box::new(|_| Some(TokenData::Quantity(QuantityData::new(1.0, QuantityUnit::Ounce)))),
        },
    ]
}
