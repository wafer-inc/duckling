...
fn test_phone_650_701_8887() {
    check_phone("650-701-8887");
}

#[test]
fn test_phone_plus1_650() {
    check_phone("(+1)650-701-8887");
    check_phone("(+1)   650 - 701  8887");
    check_phone("(+1) 650-701-8887");
    check_phone("+1 6507018887");
}

#[test]
fn test_phone_plus33() {
    check_phone("+33 1 46647998");
}

#[test]
fn test_phone_06_2070() {
    check_phone("06 2070 2220");
}

#[test]
fn test_phone_with_ext() {
    check_phone("(650)-701-8887 ext 897");
}

#[test]
fn test_phone_plus1_202() {
    check_phone("+1-202-555-0121");
    check_phone("+1 202.555.0121");
}

#[test]
fn test_phone_dots() {
    check_phone("4.8.6.6.8.2.7");
}

#[test]
fn test_phone_plain_digits() {
    check_phone("06354640807");
    check_phone("18998078030");
}

#[test]
fn test_phone_brazil_format() {
    check_phone("61 - 9 9285-2776");
    check_phone("(19) 997424919");
    check_phone("+55 19992842606");
}
